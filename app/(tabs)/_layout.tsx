...
export default function TabLayout() {
    ...
    const showDashboard = canViewDashboardModule(user);
    const showAttendance = canViewAttendanceModule(user);
    const showLive = canViewLiveAttendanceModule(user);
    ...
    const showProfile = canViewProfileModule(user);
